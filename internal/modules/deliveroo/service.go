...
// It uses the default menu ID generated by the menu mapper ("main").
func (s *DeliverooService) ToggleItemAvailability(ctx context.Context, merchantID, itemID string, available bool) error {
	brandID, err := s.repo.GetBrandIDByMerchant(ctx, merchantID)
	if err != nil {
		return err
	}
