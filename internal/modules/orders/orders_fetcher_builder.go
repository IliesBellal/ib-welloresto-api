	...
	productsByOrderID := map[string][]models.ProductEntry{}
	{
		...
		for rows.Next() {
			...
			op := models.ProductEntry{
				...
				TVAIn:                        helpers.NullFloat64Ptr(tvaIn),
				TVADelivery:                  helpers.NullFloat64Ptr(tvaDelivery),
				TVATakeAway:                  helpers.NullFloat64Ptr(tvaTakeAway),
				AvailableIn:                  helpers.NullBoolToPtr(availableIn),
				AvailableTakeAway:            helpers.NullBoolToPtr(availableTakeAway),
				AvailableDelivery:            helpers.NullBoolToPtr(availableDelivery),
