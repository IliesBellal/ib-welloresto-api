...
type ReservationRepository interface {
	...
	GetOperationRanges(ctx context.Context, merchantID int, dayOfWeek int, requestedDate string) ([]OperationRange, error)
	GetBookedCapacity(ctx context.Context, merchantID int, requestedDate string) (map[string]int, error)
	GetCustomerByPhone(ctx context.Context, tx *sql.Tx, phone string, merchantID int) (*CustomerData, error)
	GetRewards(ctx context.Context, tx *sql.Tx, customerID int) ([]Reward, error)
	CreateBooking(ctx context.Context, tx *sql.Tx, b *BookingRequest) (int64, error)
	GetBookingByNumber(ctx context.Context, bookingNumber string, merchantID int) (*BookingData, error)
...
func (r *reservationRepository) GetOperationRanges(ctx context.Context, merchantID int, dayOfWeek int, requestedDate string) ([]OperationRange, error) {
	query := `
...
func (r *reservationRepository) GetBookedCapacity(ctx context.Context, merchantID int, requestedDate string) (map[string]int, error) {
	query := `
...
func (r *reservationRepository) GetCustomerByPhone(ctx context.Context, tx *sql.Tx, phone string, merchantID int) (*CustomerData, error) {
	query := `
...
func (r *reservationRepository) GetRewards(ctx context.Context, tx *sql.Tx, customerID int) ([]Reward, error) {
	query := `
...
func (r *reservationRepository) GetBookingByNumber(ctx context.Context, bookingNumber string, merchantID int) (*BookingData, error) {
	query := `
