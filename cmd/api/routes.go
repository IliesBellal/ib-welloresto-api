...
func SetupRoutes(log *zap.Logger, selectedDB *sql.DB, cfg *config.AppConfig) *chi.Mux {
	...
	r.Route("/pos", func(r chi.Router) {
		...
		r.Route("/settings", func(r chi.Router) {
			...
			r.Get("/vacations", posH.ListPlanningVacationPeriods)
			r.Post("/vacations", posH.CreatePlanningVacationPeriod)
			r.Patch("/vacations/{id}", posH.UpdatePlanningVacationPeriod)
			r.Delete("/vacations/{id}", posH.DeletePlanningVacationPeriod)
	...
	r.Route("/planning/me", func(r chi.Router) {
		...
		r.Get("/team-week", planningH.ListCurrentUserTeamWeekShifts)
