...
-- tables (base vierge / environnement de dev, y compris la colonne
-- bookings.cancelled_by). En production ces tables préexistent au repo
-- (héritage PHP) avec des données vivantes : le up y était un no-op, ce down
-- DÉTRUIRAIT les données. Seul le retrait des index ajoutés est sûr partout.
-- ==========================================================================
