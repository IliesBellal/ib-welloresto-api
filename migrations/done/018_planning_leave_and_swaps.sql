CREATE TABLE IF NOT EXISTS planning_leave_requests (
  ...
  KEY idx_planning_leave_requests_requested_by (requested_by_user_id),
  KEY idx_planning_leave_requests_processed_by (processed_by_user_id)
...
CREATE TABLE IF NOT EXISTS planning_shift_swap_requests (
  ...
  KEY idx_planning_shift_swap_requests_requester_shift (requester_shift_id),
  KEY idx_planning_shift_swap_requests_target_shift (target_shift_id),
  KEY idx_planning_shift_swap_requests_requested_by (requested_by_user_id),
  KEY idx_planning_shift_swap_requests_processed_by (processed_by_user_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;